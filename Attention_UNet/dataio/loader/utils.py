...
def load_image(filepath, dtype=np.float32):
    '''
    Image Loader for JPG and PNG
    :param filepath: path to the input image (JPG or PNG)
    :param dtype: data type of the image numpy array
    :return: return numpy array and metadata
    '''
    # Load the image
